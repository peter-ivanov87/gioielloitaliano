...
abstract class Mage_Sales_Model_Order_Pdf_Abstract extends Varien_Object
{
    ...
    protected function insertOrder(&$page, $obj, $putOrderId = true)
    {
		...
		$page->drawText( Mage::helper('sales')->__('- Data Fattura: ') . Mage::helper('core')->formatDate( $createdDate, 'medium', false ), 115, ($top -= 15), 'UTF-8' ); //See more at: http: ww.levelzero.it/blog/magento-1-7-0-2-e-la-normativa-italiana-ed-europea-dellagenzia-delle-entrate-risoluzione-n-1e-del-10-gennaio-2013/#sthash.VewGfBfv.dpuf
