...
class Mage_Adminhtml_Block_Sales_Order_Invoice_View extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        ...
        $newid = $this->getInvoice()->getIncrementId();
        //$newid = substr((string)$newid, 1, strlen($newid));
        //$newid = $newid . "/2013";
        return Mage::helper('sales')->__('Invoice #%1$s | %2$s | %4$s (%3$s)', $newid, $this->getInvoice()->getStateName(), $emailSent, $this->formatDate($this->getInvoice()->getCreatedAtDate(), 'medium', true));
    }
