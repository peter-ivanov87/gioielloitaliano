...
class Belvg_FacebookFree_CustomerController extends Mage_Core_Controller_Front_Action {
    ...
    {
		$newPass = substr(str_shuffle('0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ'),0,7);
        ...
        $customer->setData('password', $newPass);
		...
		//$customer->setData('password',md5($newPass));
		//end
